...
def import_database_libraries(library_path) -> dict[pandas.DataFrame]:
    ...
    for sheet_name in sheet_names:
        library_dict[sheet_name] = pandas.read_excel(library_path, sheet_name=sheet_name, keep_default_na=False)
...
def main():
    ...
    try:
        ...
        print("ERROR! Close the Excel file please.")
